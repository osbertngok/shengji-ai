...
describe('DeckedCard', () => {
  it('DeckedCard constructor', () => {
    const card1: DeckedCard = new DeckedCard(1, Suits.Club, 10);
    const card2: DeckedCard = new DeckedCard(2, Suits.Joker, 2);
  ...
  it('Cards should be singleton', () => {
    const card1: DeckedCard = new DeckedCard(1, Suits.Club, 10);
    const card2: DeckedCard = new DeckedCard(1, Suits.Club, 10);
    assert.strictEqual(card1, card2);
  });

  it('Different cards should be different', () => {
    const card1: DeckedCard = new DeckedCard(1, Suits.Club, 10);
    const card2: DeckedCard = new DeckedCard(2, Suits.Club, 10);
    const card3: DeckedCard = new DeckedCard(1, Suits.Diamond, 10);
    const card4: DeckedCard = new DeckedCard(1, Suits.Club, 11);
  ...
  it('Decked Cards comparison', () => {
    const card1: DeckedCard = new DeckedCard(1, Suits.Spade, 1);
    const card2: DeckedCard = new DeckedCard(2, Suits.Spade, 1);
    const card3: DeckedCard = new DeckedCard(1, Suits.Club, 7);
    const card4: DeckedCard = new DeckedCard(1, Suits.Club, 7);
    const card5: DeckedCard = new DeckedCard(1, Suits.Joker, 2);
